                ...
                <div class="row">
                    <div class="col-12 col-lg-8">
                        <div class="form-group">
                            ...
                            <input type="hidden" name="voucher" class="rp form-control border-0 text-xl text-indigo text-bold mb-2" id="voucher" value="<?= $voucher; ?>">
                            <input type="text" name="member-modal" class="rp form-control border-0 text-xl text-indigo text-bold mb-2" id="member-modal">
